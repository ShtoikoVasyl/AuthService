...
public class RoleController {
    ...
    @Operation(summary = "Get all roles",
        description = "Retrieves a list of all roles in the system. Accessible to the users with ADMIN authority.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Create a new role",
        description = "Creates a new role in the system. Accessible to the users with ADMIN authority.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> createRole(
        @Parameter(description = "Name of the role to create", required = true) @Valid @RequestBody RoleRequest role) {
